...
bsub -W 01:00 -R "rusage[mem=64000, ngpus_excl_p=1]" -R "select[gpu_model0==GeForceRTX2080Ti]" python3 ./run.py +experiment=exp_simple_unet_backboned +test=/cluster/home/scflavio/Computational-Intelligence-Lab-2021/logs/ckpts/2021-04-10/16-22-39/last.ckpt
