...
bsub -W 01:00 -R "rusage[mem=64000, ngpus_excl_p=1]" -R "select[gpu_model0==GeForceRTX2080Ti]" python3 ./run.py +experiment=test_simple_unet_backboned +model.checkpoint_path=/cluster/home/scflavio/Computational-Intelligence-Lab-2021/logs/ckpts/2021-04-11/12-38-15/last.ckpt
